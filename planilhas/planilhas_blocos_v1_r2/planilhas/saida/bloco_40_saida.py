# bloco_40_saida — tabela de saída
import pandas as pd, streamlit as st
from planilhas.commons.bloco_00_tokens import COINS
def render_saida_panel():
    st.header("SAÍDA")
    df = pd.DataFrame({"Moeda":[""],"Side":["LONG"],"Modo":["Swing"],"Entrada":[0.0],
                       "Preço Atual":[0.0],"Alvo":[0.0],"PNL %":[0.00],"Situação":[""],
                       "Data":[""],"Hora":[""],"Excluir":[False]})
    st.data_editor(df, key="saida_editor",
        column_config={
