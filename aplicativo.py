...
df_coins = df_coins.sort_values("simbolo") if not df_coins.empty else pd.DataFrame(
columns=["simbolo","ativo","observacao","created_at","updated_at"]
)
...
# por ora, visual único — separações por modo virão depois
